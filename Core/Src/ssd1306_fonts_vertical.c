...
// Simple 5x7 font designed for vertical display
// Each character is 7 bytes (one byte per row)
const uint8_t Font5x7_Vertical[] = {
    // Space (32)
...
FontDef Font_5x7 = {5, 7, (const uint16_t*)Font5x7_Vertical};